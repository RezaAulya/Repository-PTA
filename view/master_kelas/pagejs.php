...
<script type="text/javascript" src="../assets/js/plugins/ui/fullcalendar/fullcalendar.min.js"></script>
    ...
    <script src="../assets/js/plugins/datatables.net-buttons/js/dataTables.buttons.min.js"></script>
    <script src="../assets/js/plugins/datatables.net-buttons-bs/js/buttons.bootstrap.min.js"></script>
    <script src="../assets/js/plugins/datatables.net-buttons/js/buttons.flash.min.js"></script>
    <script src="../assets/js/plugins/datatables.net-buttons/js/buttons.html5.min.js"></script>
    <script src="../assets/js/plugins/datatables.net-buttons/js/buttons.print.min.js"></script>
    <script src="../assets/js/plugins/jszip/dist/jszip.min.js"></script>
    <script src="../assets/js/plugins/pdfmake/build/pdfmake.min.js"></script>
    <script src="../assets/js/plugins/pdfmake/build/vfs_fonts.js"></script>
	...
	<script type="text/javascript" src="../assets/js/numberFormat154.js"></script>
